...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const getTodo = async () =>{
                const res = await axios.get(`https://vue-todolist.herokuapp.com/todos/${todoId} ` );
                todo.value=res.data;
                /* loading.value=false; */
            ...
            const onSave = async () => {
                ...
                try{
                    ...
                    if(props.editing){
                        res = await axios.put(`https://vue-todolist.herokuapp.com/todos/${todoId}`,data );
                    } else {
                         res = await axios.post(`https://vue-todolist.herokuapp.com/todos/`, data); 
                         todo.value.subject = "";
                         todo.value.body ="";
